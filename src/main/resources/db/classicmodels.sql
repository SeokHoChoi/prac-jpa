CREATE DATABASE /*!32312 IF NOT EXISTS*/`testboard` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `product_lines`(`product_line`,`text_description`,`html_description`,`image`) values
...
CREATE TABLE `products` (
                            ...
                            `m_s_r_p` decimal(10,2) NOT NULL,
                            PRIMARY KEY (`product_code`),
                            KEY `product_line` (`product_line`),
                            CONSTRAINT `products_ibfk_1` FOREIGN KEY (`product_line`) REFERENCES `product_lines` (`product_line`)
);

/*Data for the table `products` */

insert  into `products`(`product_code`,`product_name`,`product_line`,`product_scale`,`product_vendor`,`product_description`,`quantity_in_stock`,`buy_price`,`m_s_r_p`) values
